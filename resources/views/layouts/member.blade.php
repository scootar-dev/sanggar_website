    ...
    <body>
        ...
        <aside class="m-sidebar" id="mSidebar">
            ...
            <div class="m-user-card">
                ...
                <div>
                    ...
                    <div class="m-user-role">{{ Auth::user()->role === 'admin' ? '👑 Admin' : '🎭 Anggota' }}</div>
                </div>
            </div>
            ...
            <div class="m-sidebar-footer">
                ...
                <form method="POST" action="{{ route('logout') }}" id="logoutForm">
                    @csrf
                    <button type="button" onclick="submitLogout()" class="m-nav-item" style="width:100%;background:none;border:none;cursor:pointer;text-align:left;color:#FF6B6B;font-family:var(--font-body);font-size:.825rem;font-weight:700;">
        ...
        <header class="m-topbar">
            ...
            <div class="m-topbar-right">
                @if(Auth::user()->tipe_anggota !== 'pengunjung' && !request()->routeIs('penjadwalan'))
